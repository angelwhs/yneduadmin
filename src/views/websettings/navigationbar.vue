                ...
                <v-card ref="form">
                    ...
                    <v-card-text>
                        <v-container>
                            <v-row>
                                <v-col>
                                    <v-text-field v-model="updateItem.Title" label="名称"
                            ...
                            <v-row>
                                <v-col>
                                    <v-select :items="platformList" dense label="请选择平台类型" item-text="Name" item-value="Id"
                                    v-model="updateItem.Platform"></v-select>
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col>
            ...
            <v-dialog v-model="deleteDialog" persistent max-width="640">
                <v-card>
                    ...
                    <v-card-text>
                        ...
                        <p class="mb-1">平台：{{getPlatformName(updateItem.Platform)}}</p>
                    </v-card-text>
                    <v-card-actions>
                        <v-spacer></v-spacer>
    ...
    export default {
        ...
        methods: {
            search: function (pageIndex) {
                ...
                this.getAxios('/api/cms/backend/navigationbar/list', {
            ...
            prepareUpdateItem: function (item) {
                ...
                this.updateItem.Platform = item.Platform;
            ...
            saveUpdate: function () {
                ...
                if (this.updateItem.Id === 0) {
                    this.postAxios('/api/cms/backend/navigationbar/create', JSON.stringify(this.updateItem)).then((data) => {
                        if (data.errorcode === 0) {
                            this.loadingDialog.isShow = false;
                    ...
                    this.postAxios('/api/cms/backend/navigationbar/edit', JSON.stringify(this.updateItem)).then((data) => {
                        if (data.errorcode === 0) {
                            this.loadingDialog.isShow = false;
                            this.updateDialog.isShow = false;
            ...
            saveDelete: function () {
                ...
                this.getAxios('/api/cms/backend/navigationbar/delete', { id: this.updateItem.Id, }).then((data) => {
                    if (data.errorcode === 0) {
                        this.loadingDialog.isShow = false;
            ...
            saveSetEnable: function () {
                ...
                this.getAxios('/api/cms/backend/navigationbar/setenable', { id: this.updateItem.Id, }).then((data) => {
                    if (data.errorcode === 0) {
                        this.loadingDialog.isShow = false;
