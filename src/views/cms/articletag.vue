        ...
        methods: {
            ...
            saveUpdate: function () {
                ...
                if (this.updateItem.Id === 0) {
                    this.postAxios('/api/cms/backend/articletag/create', JSON.stringify(this.updateItem)).then((data) => {
                        if (data.errorcode === 0) {
                            this.loadingDialog.isShow = false;
                    ...
                    this.postAxios('/api/cms/backend/articletag/edit', JSON.stringify(this.updateItem)).then((data) => {
                        if (data.errorcode === 0) {
                            this.loadingDialog.isShow = false;
                            this.updateDialog.isShow = false;
            ...
            saveDelete: function () {
                ...
                this.getAxios('/api/cms/backend/articletag/delete', { id: this.updateItem.Id, }).then((data) => {
                    if (data.errorcode === 0) {
                        this.loadingDialog.isShow = false;
            ...
            saveSetEnable: function () {
                ...
                this.getAxios('/api/cms/backend/articletag/setenable', { id: this.updateItem.Id, }).then((data) => {
                    if (data.errorcode === 0) {
                        this.loadingDialog.isShow = false;
